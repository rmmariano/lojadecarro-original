...
response.meta.description='Loja de carros'
response.meta.keywords='Carros, Novos, Usados'
...
response.menu = [
    ...
    (T('Novos'), False, URL(request.application,'default','carros',args='novos'), []),
    (T('Usados'), False, URL(request.application,'default','carros',args='usados'),[])
    ]
